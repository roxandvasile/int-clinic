"use strict";
(self["webpackChunkclinic_internship_app"] = self["webpackChunkclinic_internship_app"] || []).push([["default-src_app_core_services_appointment_service_ts-node_modules_angular_material_fesm2022_d-eef144"],{
...
class AppointmentService {
  constructor(dataBase, afs) {
    this.dataBase = dataBase;
    this.afs = afs;
  }
  addAppointment(appointment) {
    const appointmentCollection = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collection)(this.dataBase, 'appointments');
    return (0,rxjs__WEBPACK_IMPORTED_MODULE_1__.from)((0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.addDoc)(appointmentCollection, appointment));
  }
  getAppointments() {
    const appointmentsCollection = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collection)(this.dataBase, 'appointments');
    return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collectionData)(appointmentsCollection, {
      idField: 'id'
    });
  }
  queryAppointments(doctorID, localDate) {
    const appointmentsRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collection)(this.dataBase, 'appointments');
    const q = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.query)(appointmentsRef, (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.where)('doctorId', '==', `${doctorID}`), (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.where)('localDate', '==', `${localDate}`));
    return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collectionData)(q);
  }
  dashboardQueryPatient(patientId) {
    const appointmentsRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collection)(this.dataBase, 'appointments');
    const q = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.query)(appointmentsRef, (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.where)('patient.uid', '==', `${patientId}`));
    return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collectionData)(q);
  }
  dashboardQueryDoctor(doctorId) {
    const appointmentsRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collection)(this.dataBase, 'appointments');
    const q = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.query)(appointmentsRef, (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.where)('doctorId', '==', `${doctorId}`));
    return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collectionData)(q);
  }
  updatePatient(patientObject, id) {
    const patientInstance = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.doc)(this.dataBase, 'patients', id);
    (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.updateDoc)(patientInstance, patientObject).catch(err => {
      console.log(err);
    });
  }
  queryAppointmentsDoctor(doctorID) {
    const appointmentsRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collection)(this.dataBase, 'appointments');
    let queryRef = appointmentsRef;
    if (doctorID) {
      queryRef = (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.query)(appointmentsRef, (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.where)('doctorId', '==', `${doctorID}`));
    }
    return (0,_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.collectionData)(queryRef);
  }
}
AppointmentService.ɵfac = function AppointmentService_Factory(t) {
  return new (t || AppointmentService)(_angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_0__.Firestore), _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵinject"](_angular_fire_compat_firestore__WEBPACK_IMPORTED_MODULE_3__.AngularFirestore));
};
...
//# sourceMappingURL=default-src_app_core_services_appointment_service_ts-node_modules_angular_material_fesm2022_d-eef144.js.map